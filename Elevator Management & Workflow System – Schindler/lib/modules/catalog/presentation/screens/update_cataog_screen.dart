...
import '../controller/update_catalog/update_catalog_binding.dart';
import '../controller/update_catalog/update_catalog_controller.dart';
class UpdateCatalogScreen extends GetView<UpdateCatalogController> {

  static const _name = '/update_catalog';
  static final page = GetPage(
      name: _name,
      page: () => const UpdateCatalogScreen(),
      binding: UpdateCatalogBinding(),
      middlewares:[
        UserPermissions().getMiddleware('catalog.update')
      ]
  );

  static void navigate(CatalogModel model) =>
              ...
              child: Column(
                children: [
                  ...
                  Card(
                    ...
                    child: GetBuilder<UpdateCatalogController>(
                      builder: (_) {
                        return ListTile(
                  ...
                  GetBuilder<UpdateCatalogController>(
                    builder: (_) {
                      return Visibility(
